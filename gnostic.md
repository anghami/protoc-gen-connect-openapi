...
option (gnostic.openapi.v3.document) = {
  info: {
    ...
    contact: {
      name: "Contact Name";
      url: "https://github.com/anghami/protoc-gen-connect-openapi";
      email: "dev@anghami.com";
    }
    license: {
      name: "MIT License";
      url: "https://github.com/anghami/protoc-gen-connect-openapi/blob/master/LICENSE";
    }
  }
  components: {
    security_schemes: {
...
For more information on how to use each option in your Protobuf file, you can reference [the gnostic.openapi.v3 module documentation](https://buf.build/gnostic/gnostic/docs/main:gnostic.openapi.v3) and the [google/gnostic repo](https://github.com/google/gnostic). Note that this is a new feature, so if find something that isn't supported that you need, please [create an issue](https://github.com/anghami/protoc-gen-connect-openapi/issues/new).
